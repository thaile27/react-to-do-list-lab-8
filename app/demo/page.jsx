...
/*
	Data
	Understand how the data is coming in
	array of objects is preferred... JSON

	Object of objects
	FB data is an object

	Object.keys(firebaseObject)
	Object.entries(firebaseObject) [{key: value}, {key: value}, {key: value}]
	Object.values(firebaseObject) [[k, v], [k,v], [k,v]]
